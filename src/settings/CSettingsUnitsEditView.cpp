...
void CSettingsUnitsEditView::constructLayout()
{
  ...
  QComboBox* __pqComboBoxUnitDate = new QComboBox();
  ...
  QComboBox* __pqComboBoxUnitTime = new QComboBox();
  ...
  QSpinBox* __pqSpinBoxPrecisionTime = new QSpinBox();
  ...
  QComboBox* __pqComboBoxUnitTimeDelta = new QComboBox();
  ...
  QSpinBox* __pqSpinBoxPrecisionTimeDelta = new QSpinBox();
  ...
  QComboBox* __pqComboBoxUnitTimeZone = new QComboBox();
  ...
  QComboBox* __pqComboBoxUnitPosition = new QComboBox();
  ...
  QSpinBox* __pqSpinBoxPrecisionPosition = new QSpinBox();
  ...
  QComboBox* __pqComboBoxUnitBearing = new QComboBox();
  ...
  QSpinBox* __pqSpinBoxPrecisionBearing = new QSpinBox();
  ...
  QComboBox* __pqComboBoxUnitDistance = new QComboBox();
  ...
  QSpinBox* __pqSpinBoxPrecisionDistance = new QSpinBox();
  ...
  QComboBox* __pqComboBoxUnitSpeed = new QComboBox();
  ...
  QSpinBox* __pqSpinBoxPrecisionSpeed = new QSpinBox();
  ...
  QComboBox* __pqComboBoxUnitElevation = new QComboBox();
  ...
  QSpinBox* __pqSpinBoxPrecisionElevation = new QSpinBox();
  ...
  QComboBox* __pqComboBoxUnitSpeedVertical = new QComboBox();
  ...
  QSpinBox* __pqSpinBoxPrecisionSpeedVertical = new QSpinBox();

...
void CVesselContainerDetailView::constructLayout()
{
  ...
  // ... set device
  pqPushButtonSetDevice = new QPushButton( QIcon( ":icons/32x32/device_add.png" ), "", this );
  ...
  // ... add point
  pqPushButtonAddPoint = new QPushButton( QIcon( ":icons/32x32/vessel_add.png" ), "", this );
...
void CVesselContainerDetailView::slotToggleVisible()
{
  ...
  __poVesselContainer->toggleVisible();

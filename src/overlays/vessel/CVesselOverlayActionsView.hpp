...
#ifndef QVCT_CVESSELOVERLAYACTIONSVIEW_HPP
#define QVCT_CVESSELOVERLAYACTIONSVIEW_HPP
 ...
 *  actions on vessel overlay objects.
 *  @author Cedric Dufour <http://cedric.dufour.name>
 */
class CVesselOverlayActionsView: public COverlayActionsView
{
  Q_OBJECT
...
public:
  ...
  virtual ~CVesselOverlayActionsView() {};
...
#endif // QVCT_CVESSELOVERLAYACTIONSVIEW_HPP

...
#ifndef QVCT_CTRACKCONTAINERDETAILVIEW_HPP
#define QVCT_CTRACKCONTAINERDETAILVIEW_HPP
 ...
 *  @author Cedric Dufour <http://cedric.dufour.name>
 */
class CTrackContainerDetailView: public COverlayObjectDetailView
{
  Q_OBJECT
...
public:
  CTrackContainerDetailView( QWidget* _pqParent );
...
#endif // QVCT_CTRACKCONTAINERDETAILVIEW_HPP

...
#ifndef QVCT_CTRACKOVERLAYACTIONSVIEW_HPP
#define QVCT_CTRACKOVERLAYACTIONSVIEW_HPP
 ...
 *  actions on track overlay objects.
 *  @author Cedric Dufour <http://cedric.dufour.name>
 */
class CTrackOverlayActionsView: public COverlayActionsView
{
  Q_OBJECT
...
public:
  ...
  virtual ~CTrackOverlayActionsView() {};
...
#endif // QVCT_CTRACKOVERLAYACTIONSVIEW_HPP

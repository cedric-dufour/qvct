...
#ifndef QVCT_CROUTEOVERLAYLISTVIEW_HPP
#define QVCT_CROUTEOVERLAYLISTVIEW_HPP
 ...
 *  @author Cedric Dufour <http://cedric.dufour.name>
 */
class CRouteOverlayListView: public QWidget
{
  Q_OBJECT
...
#endif // QVCT_CROUTEOVERLAYLISTVIEW_HPP

...
#ifndef QVCT_CROUTECONTAINEREDITVIEW_HPP
#define QVCT_CROUTECONTAINEREDITVIEW_HPP
 ...
 *  @author Cedric Dufour <http://cedric.dufour.name>
 */
class CRouteContainerEditView: public COverlayObjectEditView
{
...
public:
  ...
  virtual ~CRouteContainerEditView() {};
...
#endif // QVCT_CROUTECONTAINEREDITVIEW_HPP

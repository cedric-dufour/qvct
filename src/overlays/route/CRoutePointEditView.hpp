...
#ifndef QVCT_CROUTEITEMEDITVIEW_HPP
#define QVCT_CROUTEITEMEDITVIEW_HPP
 ...
 *  @author Cedric Dufour <http://cedric.dufour.name>
 */
class CRoutePointEditView: public COverlayObjectEditView
{
...
#endif // QVCT_CROUTEITEMEDITVIEW_HPP

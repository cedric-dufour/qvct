...
#ifndef QVCT_CLANDMARKOVERLAYACTIONSVIEW_HPP
#define QVCT_CLANDMARKOVERLAYACTIONSVIEW_HPP
 ...
 *  actions on landmark overlay objects.
 *  @author Cedric Dufour <http://cedric.dufour.name>
 */
class CLandmarkOverlayActionsView: public COverlayActionsView
{
  Q_OBJECT
...
public:
  CLandmarkOverlayActionsView();
  virtual ~CLandmarkOverlayActionsView() {};
...
#endif // QVCT_CLANDMARKOVERLAYACTIONSVIEW_HPP

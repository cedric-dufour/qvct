...
#ifndef QVCT_CLANDMARKOVERLAYLISTVIEW_HPP
#define QVCT_CLANDMARKOVERLAYLISTVIEW_HPP
 ...
 *  @author Cedric Dufour <http://cedric.dufour.name>
 */
class CLandmarkOverlayListView: public QWidget
{
  Q_OBJECT
...
#endif // QVCT_CLANDMARKOVERLAYLISTVIEW_HPP

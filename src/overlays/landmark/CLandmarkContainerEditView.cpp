...
CLandmarkContainerEditView::CLandmarkContainerEditView( CLandmarkContainer* _poLandmarkContainer )
  : COverlayObjectEditView( _poLandmarkContainer )
{
  constructLayout();
}
...
void CLandmarkContainerEditView::accept()
{
  CLandmarkContainer* __poLandmarkContainer = (CLandmarkContainer*)poOverlayObject;

  // Set data
  // ... name
  __poLandmarkContainer->setText( CLandmarkOverlay::NAME, pqLineEditName->text() ); // NOTE: Container's name will be updated via QTreeWidget::containerChanged()
